...
evmc::result EVMHost::precompileSha256(evmc_message const& _message) noexcept
{
	...
	gas_cost += ((_message.input_size + 31) / 32) * evmasm::GasCosts::precompileSha256PerWordGas;
...
evmc::result EVMHost::precompileIdentity(evmc_message const& _message) noexcept
{
	...
	gas_cost += ((_message.input_size + 31) / 32) * evmasm::GasCosts::precompileIdentityPerWordGas;
