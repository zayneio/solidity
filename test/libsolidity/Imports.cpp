...
{
	CompilerStack c;
	c.setRemappings(vector<FileRemapper::Remapping>{{"", "s", "s_1.4.6"},{"", "t", "Tee"}});
	c.setSources({
...
{
	CompilerStack c;
	c.setRemappings(vector<FileRemapper::Remapping>{{"a", "s", "s_1.4.6"}, {"b", "s", "s_1.4.7"}});
	c.setSources({
...
{
	CompilerStack c;
	c.setRemappings(vector<FileRemapper::Remapping>{
...
{
	CompilerStack c;
	c.setRemappings(vector<FileRemapper::Remapping>{{"a", "x/y/z", "d"}, {"a/b", "x", "e"}});
	c.setSources({
...
{
	CompilerStack c;
	c.setRemappings(vector<FileRemapper::Remapping>{{"a/b", "x", "e"}, {"a", "x/y/z", "d"}});
	c.setSources({
		{"a/main.sol", "import \"x/y/z/z.sol\"; contract Main is D {} pragma solidity >=0.0;"},
		{"a/b/main.sol", "import \"x/y/z/z.sol\"; contract Main is E {} pragma solidity >=0.0;"},
		{"d/z.sol", "contract D {} pragma solidity >=0.0;"},
