...
void FileRemapper::setRemappings(std::vector<Remapping> _remappings)
{
...
SourceUnitID FileRemapper::apply(ImportPath const& _path, std::string const& _context) const
{
...
optional<FileRemapper::Remapping> FileRemapper::parseRemapping(string const& _remapping)
{
